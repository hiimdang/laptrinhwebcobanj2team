                ...
                <li>
                    ...
                    <div class="task_right">
                        <div id="search_box">
                            ...
                            <input type="search" placeholder="Search" id="input" name="tim_kiem">
                        </div>
                        <a href="#">
            ...
            <?php foreach ($ket_qua as $tung_san_pham){?>
                <div class="product_card wrapper">
                    <div class="product_img">
                        <a href="form_update_giay.php?ma=<?php echo $tung_san_pham['ma'] ?>">
                    ...
                    <div class="product_info_before">
                        ...
                        <div class="product_card_buy_button_div">
                            <button class="buy_button" onclick="window.location='form_update_giay.php?ma=<?php echo $tung_san_pham['ma'] ?>';">Update</button>
                            <button class="delete_button" onclick="window.location='cau_hoi_delete.php?ma=<?php echo $tung_san_pham['ma'] ?>'">Delete</button>
                        </div>
                    </div>
                </div>
            <?php } ?>
